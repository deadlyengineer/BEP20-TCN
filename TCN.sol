...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 1 * (10 ** 18); // 0.0001 WBNB minimum auto send
...
contract TCN is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "TrustChain Network";
    string constant _symbol = "TCN";
    ...
    constructor (address _presaler, address _presaleContract) {
